...
class React2Pdf {
    ...
    addPage(div) {
        __classPrivateFieldGet(this, _React2Pdf_pages, "f").push(jsxRuntime.jsxs("div", { style: { "pageBreakAfter": "always" }, children: [" ", div, " "] }, "page" + __classPrivateFieldGet(this, _React2Pdf_pages, "f").length));
    }
...
_React2Pdf_browser = new WeakMap(), _React2Pdf_pages = new WeakMap(), _React2Pdf_instances = new WeakSet(), _React2Pdf_buildDocument = async function _React2Pdf_buildDocument() {
    ...
    let html = ReactDOMServer.renderToString(jsxRuntime.jsx("div", { children: __classPrivateFieldGet(this, _React2Pdf_pages, "f") }));
